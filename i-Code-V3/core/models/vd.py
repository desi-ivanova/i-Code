...
from .diffusion_utils import count_params, extract_into_tensor, make_beta_schedule
...
class VD(DDPM):
    def __init__(
        ...
        **kwargs
        ...
        self.clap = CLAPAudioEmbeddingClassifierFreev2(
            joint_embed_shape=768, amodel="HTSAT-large"
        )
        self.clap.eval()
    ...
    def autokl_decode(self, z):
        z = 1.0 / self.image_scale_factor * z
    ...
    def mask_tokens(inputs, tokenizer, args):
        ...
        indices_replaced = (
            torch.bernoulli(torch.full(labels.shape, 0.8)).to(torch.uint8)
            & masked_indices
        )
    ...
    def optimus_decode(self, z, temperature=1.0):
        ...
        for zi in z:
            ...
            text = self.optimus.tokenizer_decoder.decode(
